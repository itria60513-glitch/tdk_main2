...
If the feature changes an IDisposable module or event-driven hardware actor, the
task list MUST include explicit implementation and test tasks for disposed-state
guards, idempotent Dispose behavior, and post-dispose callback/event safety.
...
- [ ] T010 Define disposed-state and lifecycle safety approach for any
  IDisposable or event-driven module touched by the feature
...
- [ ] T013 [P] [US1] Dispose/use-after-dispose tests for impacted module in tests/unit/
